---
title: 'Achieving Scalability and High Availability with Nginx and Docker'
summary: 'We will explore the powerful combination of Nginx as a load balancer and Docker Compose for orchestrating multiple Express-based apps.'
publishedAt: '2023-07-06'
image: '/assets/overthoughts/achieving-scalability-and-high-availability-with-nginx-and-docker/cover.jpg'
---
