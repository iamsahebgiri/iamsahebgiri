---
title: 'Printing floats in Java'
summary: 'Multiple ways of printing float to n decimal places in Java using printf, format and DecimalFormat.'
publishedAt: '2021-01-02'
image: '/assets/overthoughts/format-float-to-n-decimal-places-in-java/cover.jpg'
---
