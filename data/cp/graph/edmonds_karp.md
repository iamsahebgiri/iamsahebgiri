...
<center>![First path](&imgroot&/Flow2.png)</center>
<center>![Network after first path](&imgroot&/Flow3.png)</center>
...
<center>![Second path](&imgroot&/Flow4.png)</center>
<center>![Network after second path](&imgroot&/Flow5.png)</center>

This time we find the path $s - D - C - B - t$ with the residual capacities 1, 2, 3 and 3, and we increase by 1.
<center>![Third path](&imgroot&/Flow6.png)</center>
<center>![Network after third path](&imgroot&/Flow7.png)</center>
...
<center>![Fourth path](&imgroot&/Flow8.png)</center>
<center>![Network after fourth path](&imgroot&/Flow9.png)</center>
