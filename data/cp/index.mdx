...
**Credits:**
All articles and data belongs to [CP Algorithm](https://cp-algorithms.com/) and the contributors.

The main goal of this project is to provide accessible  and readable content even on smaller devices keeping UX in mind.