...
![Suffix automaton for ""](/img/SA.png)

For the string $s =~ "a"$:

![Suffix automaton for "a"](/img/SAa.png)

For the string $s =~ "aa"$:

![Suffix automaton for "aa"](/img/SAaa.png)

For the string $s =~ "ab"$:

![Suffix automaton for "ab"](/img/SAab.png)

For the string $s =~ "aba"$:

![Suffix automaton for "aba"](/img/SAaba.png)

For the string $s =~ "abb"$:

![Suffix automaton for "abb"](/img/SAabb.png)

For the string $s =~ "abbb"$:

![Suffix automaton for "abbb"](/img/SAabbb.png)
...
![Suffix automaton for "abcbc" with suffix links](/img/SA_suffix_links.png)
