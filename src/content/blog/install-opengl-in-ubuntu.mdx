---
title: 'Bringing Graphics to Life: My OpenGL Adventure on Ubuntu'
description: 'OpenGL is a Graphics rendering API which is operating system independent, window system independent and has high-quality color images composed of geometric and image primitives.'
pubDate: 'December 02 2020'
...
Now lets see How I installed OpenGL on out Ubuntu OS.
