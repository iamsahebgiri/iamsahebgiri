---
title: 'Build Your Own React Router in 45 Lines'
description: 'A minimal client-side router in React that swaps components based on pathname. 45 lines, no dependencies.'
