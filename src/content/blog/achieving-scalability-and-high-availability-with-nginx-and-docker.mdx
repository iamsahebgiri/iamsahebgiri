---
title: 'Deploy a Highly Available Node.js App with Nginx and Docker Compose'
description: 'Use Nginx as a load balancer and Docker Compose to run multiple Express instances. Covers load distribution and basic failover.'
